...
export type ArticlePostByIdQuery = { markdownRemark?: Maybe<(
    ...
    & { frontmatter?: Maybe<(
      ...
      & { featuredimage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, author?: Maybe<Pick<MarkdownRemarkFrontmatterAuthor, 'name' | 'url'>> }
    )> }
  )> };
...
export type IndexPageTemplateQuery = { markdownRemark?: Maybe<{ frontmatter?: Maybe<(
      ...
      & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, cover?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, mainImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, editorNote?: Maybe<Pick<MarkdownRemarkFrontmatterEditorNote, 'title' | 'description'>>, advice?: Maybe<(
        Pick<MarkdownRemarkFrontmatterAdvice, 'text'>
        & { left?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, right?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }
        ...
        )>>> }>, doodles?: Maybe<Array<Maybe<{ image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }>>> }
    )> }> };
...
export type ListArticlePostByIdQuery = { markdownRemark?: Maybe<(
    ...
    & { frontmatter?: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'tags'>
      & { featuredimage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, author?: Maybe<Pick<MarkdownRemarkFrontmatterAuthor, 'name' | 'url'>>, list?: Maybe<Array<Maybe<Pick<MarkdownRemarkFrontmatterList, 'title' | 'text'>>>> }
    )> }
  )> };
