...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___mainImage___sourceInstanceName'
  | 'childMarkdownRemark___frontmatter___mainImage___absolutePath'
  | 'childMarkdownRemark___frontmatter___mainImage___relativePath'
  | 'childMarkdownRemark___frontmatter___mainImage___extension'
  | 'childMarkdownRemark___frontmatter___mainImage___size'
  | 'childMarkdownRemark___frontmatter___mainImage___prettySize'
  | 'childMarkdownRemark___frontmatter___mainImage___modifiedTime'
  | 'childMarkdownRemark___frontmatter___mainImage___accessTime'
  | 'childMarkdownRemark___frontmatter___mainImage___changeTime'
  | 'childMarkdownRemark___frontmatter___mainImage___birthTime'
  | 'childMarkdownRemark___frontmatter___mainImage___root'
  | 'childMarkdownRemark___frontmatter___mainImage___dir'
  | 'childMarkdownRemark___frontmatter___mainImage___base'
  | 'childMarkdownRemark___frontmatter___mainImage___ext'
  | 'childMarkdownRemark___frontmatter___mainImage___name'
  | 'childMarkdownRemark___frontmatter___mainImage___relativeDirectory'
  | 'childMarkdownRemark___frontmatter___mainImage___dev'
  | 'childMarkdownRemark___frontmatter___mainImage___mode'
  | 'childMarkdownRemark___frontmatter___mainImage___nlink'
  | 'childMarkdownRemark___frontmatter___mainImage___uid'
  | 'childMarkdownRemark___frontmatter___mainImage___gid'
  | 'childMarkdownRemark___frontmatter___mainImage___rdev'
  | 'childMarkdownRemark___frontmatter___mainImage___ino'
  | 'childMarkdownRemark___frontmatter___mainImage___atimeMs'
  | 'childMarkdownRemark___frontmatter___mainImage___mtimeMs'
  | 'childMarkdownRemark___frontmatter___mainImage___ctimeMs'
  | 'childMarkdownRemark___frontmatter___mainImage___atime'
  | 'childMarkdownRemark___frontmatter___mainImage___mtime'
  | 'childMarkdownRemark___frontmatter___mainImage___ctime'
  | 'childMarkdownRemark___frontmatter___mainImage___birthtime'
  | 'childMarkdownRemark___frontmatter___mainImage___birthtimeMs'
  | 'childMarkdownRemark___frontmatter___mainImage___blksize'
  | 'childMarkdownRemark___frontmatter___mainImage___blocks'
  | 'childMarkdownRemark___frontmatter___mainImage___publicURL'
  | 'childMarkdownRemark___frontmatter___mainImage___id'
  | 'childMarkdownRemark___frontmatter___mainImage___children'
  ...
  | 'childMarkdownRemark___frontmatter___advice___text'
  ...
  | 'childMarkdownRemark___frontmatter___author___name'
  | 'childMarkdownRemark___frontmatter___author___url'
  | 'childMarkdownRemark___frontmatter___tags'
  | 'childMarkdownRemark___frontmatter___featuredVideo___webm'
...
export type MarkdownRemarkFieldsEnum = 
  ...
  | 'frontmatter___mainImage___childMarkdownRemark___id'
  | 'frontmatter___mainImage___childMarkdownRemark___excerpt'
  | 'frontmatter___mainImage___childMarkdownRemark___rawMarkdownBody'
  | 'frontmatter___mainImage___childMarkdownRemark___fileAbsolutePath'
  | 'frontmatter___mainImage___childMarkdownRemark___html'
  | 'frontmatter___mainImage___childMarkdownRemark___htmlAst'
  | 'frontmatter___mainImage___childMarkdownRemark___excerptAst'
  | 'frontmatter___mainImage___childMarkdownRemark___headings'
  | 'frontmatter___mainImage___childMarkdownRemark___timeToRead'
  | 'frontmatter___mainImage___childMarkdownRemark___tableOfContents'
  | 'frontmatter___mainImage___childMarkdownRemark___children'
  ...
  | 'frontmatter___covidGuidelines___text___list'
  ...
  | 'frontmatter___articles___blurbs___title'
  | 'frontmatter___articles___blurbs___subtitle'
  | 'frontmatter___articles___blurbs___path'
  | 'frontmatter___date'
  ...
  | 'frontmatter___tags'
  | 'frontmatter___featuredVideo___webm'
...
export type MarkdownRemarkFrontmatterCovidGuidelines = {
  title?: Maybe<Scalars['String']>;
  description?: Maybe<Scalars['String']>;
  text?: Maybe<MarkdownRemarkFrontmatterCovidGuidelinesText>;
};

export type MarkdownRemarkFrontmatterCovidGuidelinesFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  description?: Maybe<StringQueryOperatorInput>;
  text?: Maybe<MarkdownRemarkFrontmatterCovidGuidelinesTextFilterInput>;
};

export type MarkdownRemarkFrontmatterCovidGuidelinesText = {
  para?: Maybe<Scalars['String']>;
  list?: Maybe<Array<Maybe<Scalars['String']>>>;
};

export type MarkdownRemarkFrontmatterCovidGuidelinesTextFilterInput = {
  para?: Maybe<StringQueryOperatorInput>;
...
export type MarkdownRemarkFrontmatterFeaturedVideo = {
  webm?: Maybe<Scalars['String']>;
  mp4?: Maybe<Scalars['String']>;
  mobileWebm?: Maybe<Scalars['String']>;
  mobileMp4?: Maybe<Scalars['String']>;
};

export type MarkdownRemarkFrontmatterFeaturedVideoFilterInput = {
  webm?: Maybe<StringQueryOperatorInput>;
  mp4?: Maybe<StringQueryOperatorInput>;
  mobileWebm?: Maybe<StringQueryOperatorInput>;
  mobileMp4?: Maybe<StringQueryOperatorInput>;
};
...
export type MarkdownRemarkFrontmatterList = {
  title?: Maybe<Scalars['String']>;
  text?: Maybe<Scalars['String']>;
};

export type MarkdownRemarkFrontmatterListFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  text?: Maybe<StringQueryOperatorInput>;
};
...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___containerClass'
...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___plugins___pluginOptions___containerClass'
  ...
  | 'pluginOptions___containerClass'
...
export type ArticleRollQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type ArticleRollQueryQuery = { allMarkdownRemark: { edges: Array<{ node: (
...
export type SearchIndexQueryQueryVariables = Exact<{ [key: string]: never; }>;
...
export type ArticlePostByIdQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type ArticlePostByIdQuery = { markdownRemark?: Maybe<(
...
export type IndexPageTemplateQuery = { markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'html'>
    & { frontmatter?: Maybe<(
      ...
      & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }>, cover?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }>, mainImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }>, video?: Maybe<Pick<MarkdownRemarkFrontmatterVideo, 'webm' | 'mp4'>>, advice?: Maybe<(
        ...
        Pick<MarkdownRemarkFrontmatterCovidGuidelines, 'title' | 'description'>
        & { text?: Maybe<Pick<MarkdownRemarkFrontmatterCovidGuidelinesText, 'para' | 'list'>> }
      )>, articles?: Maybe<{ blurbs?: Maybe<Array<Maybe<(
          Pick<MarkdownRemarkFrontmatterArticlesBlurbs, 'title' | 'subtitle' | 'path'>
          & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> }
        )>>> }>, doodles?: Maybe<Array<Maybe<{ image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }> }>>> }
    )> }
  )> };

export type ListArticlePostByIdQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type ListArticlePostByIdQuery = { markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'id' | 'html'>
    & { frontmatter?: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title'>
      & { featuredimage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluid_WithWebpFragment> }> }>, author?: Maybe<Pick<MarkdownRemarkFrontmatterAuthor, 'name' | 'url'>>, list?: Maybe<Array<Maybe<Pick<MarkdownRemarkFrontmatterList, 'title' | 'text'>>>> }
    )> }
  )> };
