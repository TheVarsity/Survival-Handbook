...
export type ArticleRollQueryQuery = {
    allMarkdownRemark: {
        edges: Array<{
...
export type ArticlePostByIdQuery = {
    markdownRemark?: Maybe<
        Pick<MarkdownRemark, 'id' | 'html'> & {
            frontmatter?: Maybe<
                Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'tags'> & {
                    ...
                    author?: Maybe<Pick<MarkdownRemarkFrontmatterAuthor, 'name' | 'url'>>;
                }
            >;
        }
    >;
                ...
                articles?: Maybe<{
                    blurbs?: Maybe<
                        Array<
                            Maybe<
                                Pick<
                                    MarkdownRemarkFrontmatterArticlesBlurbs,
                                    'title' | 'subtitle' | 'path'
                                > & {
                                    image?: Maybe<{
                                        childImageSharp?: Maybe<{
...
export type ListArticlePostByIdQuery = {
    markdownRemark?: Maybe<
        Pick<MarkdownRemark, 'id' | 'html'> & {
            frontmatter?: Maybe<
                Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'tags'> & {
                    ...
                    author?: Maybe<Pick<MarkdownRemarkFrontmatterAuthor, 'name' | 'url'>>;
                    list?: Maybe<
                        Array<Maybe<Pick<MarkdownRemarkFrontmatterList, 'title' | 'text'>>>
                    >;
                }
            >;
        }
