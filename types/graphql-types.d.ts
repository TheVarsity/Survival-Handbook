...
export type IndexPageTemplateQuery = { markdownRemark?: Maybe<{ frontmatter?: Maybe<(
      ...
      & { image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, cover?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, editorNote?: Maybe<Pick<MarkdownRemarkFrontmatterEditorNote, 'title' | 'description'>>, advice?: Maybe<{ left?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }>, right?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }>, articles?: Maybe<(
        Pick<MarkdownRemarkFrontmatterArticles, 'heading' | 'description'>
        & { blurbs?: Maybe<Array<Maybe<{ image?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> }>>> }
